  ...
  <div class="book-detail">
    ...
    <div class="book-info">
      ...
      <div class="buttons">
        ...
        <button @click="buyNow" class="buy-btn">📥 Pinjam Buku</button>
      </div>
  ...
  data() {
    return {
      book: {
        ...
        description: "Advance Aircraft Systems* merupakan sebuah buku ...",
        language: "Indonesia",
  ...
  methods: {
    loadBook(id) {
      const books = [
        ...
        {
          id: 2,
          title: "AIRCRAFT CONTROL AND SIMULATION BRIAN L. STEVENS",
          imageUrl: '/cover_buku/AIRCRAFT CONTROL AND SIMULATION BRIAN L. STEVENS.jpg',
          price: "Pinjam Buku",
          appLink: "#",
          description: "Buku Aircraft Control and Simulation karya Brian L. Stevens merupakan referensi teknis yang sangat mendalam dan komprehensif dalam bidang kendali dan simulasi pesawat terbang. Buku ini membahas teori kontrol penerbangan mulai dari konsep dasar hingga aplikasi lanjutan, serta menyajikan pendekatan numerik dan simulasi modern untuk mendesain dan menguji sistem kontrol pesawat. Dilengkapi dengan studi kasus, diagram, serta implementasi simulasi berbasis komputer, buku ini menjadi sumber yang sangat berharga bagi mahasiswa teknik dirgantara, insinyur sistem kontrol, serta para profesional yang ingin memahami lebih lanjut tentang dinamika penerbangan dan kendali otomatis. Dengan pendekatan yang sistematis dan berbasis praktik, buku ini menjadi fondasi penting dalam pengembangan teknologi kontrol penerbangan masa kini.",
          language: "Indonesia",
          publisher: "Gramedia",
          author: "Brian L.Stevens",
          releaseDate: "15 Januari 2020",
          pages: 240,
          format: "PDF",
        },
        
        // Tambah lagi buku lain jika perlu
      ];
      ...
      if (found) {
        ...
        this.book = {
          ...
          imageUrl: "/cover_buku/not-found.jpg",
          description: "",
          language: "-",
          publisher: "-",
          author: "-",
    ...
    setRating(value) {
      this.rating = this.rating === value ? value - 0 : value;
    },
